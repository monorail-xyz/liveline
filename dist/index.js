...
function Liveline({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    matchTimeline && /* @__PURE__ */ jsx("style", { children: `@keyframes liveline-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.4; } }` }),
    (effectiveWindows && effectiveWindows.length > 0 || onModeChange || showSeriesToggle) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6, marginLeft: pad.left }, children: [
      effectiveWindows && effectiveWindows.length > 0 && /* @__PURE__ */ jsxs(
        "div",
        {
          ref: windowBarRef,
          style: {
